 ...
 *
 * Prérequis : API (:8000) + front dev (:3000) + seed lancés.
 * Usage :     cd frontend && node ../tools/screenshots.mjs
 *
 * Thème sombre forcé, viewport 1440×900 retina. Sorties dans
 * frontend/public/screenshots/*.png (viewport, above-the-fold).
 */
...
const OUT = join(dirname(fileURLToPath(import.meta.url)), '..', 'frontend', 'public', 'screenshots')
